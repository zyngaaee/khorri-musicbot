...
const { registerSpotifyAuthRoutes } = require('./utils/spotifyOAuth.js');
...
// Increase listener limit to prevent false memory leak warnings from Discord.js sharding
...
app.listen(port, () => {
    ...
    console.log(`${colors.cyan}[ USER ]${colors.reset} ${colors.yellow}OGTomz${colors.reset}`);
});
